...
object SlickHasPrivilege {
  ...
  implicit def MasterCanWrite(
    implicit profile: SlickProfile[Master],
  ): Master SlickHasPrivilege profile.api.Effect.Write = null

  implicit def MasterCanSchema(
    implicit profile: SlickProfile[Master],
  ): Master SlickHasPrivilege profile.api.Effect.Schema = null

  implicit def MasterCanPerformTransactions(
    implicit profile: SlickProfile[Master],
  ): Master SlickHasPrivilege profile.api.Effect.Write with profile.api.Effect.Transactional = null
