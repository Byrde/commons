...
package object implicits extends BodyWritableSupport with ProxyRequestSupport {
  ...
  implicit def generic__ResponseDecoder[T](
    implicit decoder: Decoder[T]
  ): ResponseDecoder[PlayService, StandaloneWSRequest, StandaloneWSResponse, T] =
  ...
  implicit def serviceResponse__ResponseDecoder[T](
    implicit decoder: Decoder[T]
  ): ResponseDecoder[PlayService, StandaloneWSRequest, StandaloneWSResponse, ServiceResponse[T]] =
