...
case class JsResultCompressor(jsConfig: JsCompressorConfig)(implicit ec: ExecutionContext, mat: Materializer) extends ResultCompressor[YuiJavaScriptCompressor]{
