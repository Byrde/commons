...
class CoordinatesSpec extends AnyFlatSpec with Matchers with ScalaCheckDrivenPropertyChecks {
  private val (zero, upperBound) =
    (0.0, 6371.0 * math.Pi)

  private val beWithinKmBounds: Matcher[Double] =
    not((be < zero)(TotalOrdering) or (be > upperBound)(TotalOrdering))
  ...
  private val CityLimits =
    Coordinates(45.062965, -74.765300)

  private val MyHouse =
    Coordinates(45.069483, -74.776060)

  private val ParentsHouse =
    Coordinates(45.054762, -74.789938)

  private val CornwallAreaDiameter: Double =
    30.0

  "Coordinates.distance" should "be consistent" in forAll(CornwallAreaCoordinates, CornwallAreaCoordinates, minSuccessful(10000)) { (a, b) =>
  ...
  it should "work in small areas" in forAll(CornwallAreaCoordinates, CornwallAreaCoordinates, minSuccessful(10000)) { (a, b) =>
